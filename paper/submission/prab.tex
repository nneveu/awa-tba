...
\bibitem [{\citenamefont {Terzi\ifmmode~\acute{c}\else \'{c}\fi{}}\ \emph
	{et~al.}(2014)\citenamefont {Terzi\ifmmode~\acute{c}\else \'{c}\fi{}},
...
\BibitemOpen
\bibfield  {author} {\bibinfo {author} {\bibfnamefont {B.~c.~v.}\
		\bibnamefont {Terzi\ifmmode~\acute{c}\else \'{c}\fi{}}}, \bibinfo {author}
	{\bibfnamefont {A.~S.}\ \bibnamefont {Hofler}}, \bibinfo {author}
	{\bibfnamefont {C.~J.}\ \bibnamefont {Reeves}}, \bibinfo {author}
	{\bibfnamefont {S.~A.}\ \bibnamefont {Khan}}, \bibinfo {author}
