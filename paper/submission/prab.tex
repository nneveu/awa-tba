...
Using evolutionary algorithms as the optimizer and \textsc{OPAL} as the 
  forward solver, validation experiments and 
 results of multi-objective optimization problems in the domain of beam
  dynamics are presented. The high charge beam line at the Argonne Wakefield 
  Accelerator Facility was used as the beam dynamics model. 
...
In order to be able to reliably identify optimal configurations of
  ...
  This approach has been used in the past [] with much success.
The difference here being the implementation and application to a novel
