...
\begin{thebibliography}{34}%
	...
	\bibitem [{\citenamefont {Chao}\ \emph {et~al.}(2009)\citenamefont {Chao},
		\citenamefont {Ames}, \citenamefont {Baartman}, \citenamefont {Bylinskii},
		\citenamefont {Dechoudhury}, \citenamefont {Goh}, \citenamefont
		{Koscielniak}, \citenamefont {E~Laxdal}, \citenamefont {Marchetto},
		\citenamefont {Merminga}, \citenamefont {Naik}, \citenamefont {A~Verzilov},
		\citenamefont {Yan},\ and\ \citenamefont {Zvyagintsev}}]{chao09}%
	\BibitemOpen
	\bibfield  {author} {\bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont
			{Chao}}, \bibinfo {author} {\bibfnamefont {F.}~\bibnamefont {Ames}}, \bibinfo
		{author} {\bibfnamefont {R.}~\bibnamefont {Baartman}}, \bibinfo {author}
		{\bibfnamefont {I.}~\bibnamefont {Bylinskii}}, \bibinfo {author}
		{\bibfnamefont {S.}~\bibnamefont {Dechoudhury}}, \bibinfo {author}
		{\bibfnamefont {G.}~\bibnamefont {Goh}}, \bibinfo {author} {\bibfnamefont
			{S.}~\bibnamefont {Koscielniak}}, \bibinfo {author} {\bibfnamefont
			{R.}~\bibnamefont {E~Laxdal}}, \bibinfo {author} {\bibfnamefont
			{M.}~\bibnamefont {Marchetto}}, \bibinfo {author} {\bibfnamefont
			{L.}~\bibnamefont {Merminga}}, \bibinfo {author} {\bibfnamefont
			{V.}~\bibnamefont {Naik}}, \bibinfo {author} {\bibfnamefont {V.}~\bibnamefont
			{A~Verzilov}}, \bibinfo {author} {\bibfnamefont {F.}~\bibnamefont {Yan}}, \
		and\ \bibinfo {author} {\bibfnamefont {V.}~\bibnamefont {Zvyagintsev}},\ }in\
	\href@noop {} {\emph {\bibinfo {booktitle} {Proc. of ICAP}}}\ (\bibinfo
	{year} {2009})\ p.\ \bibinfo {pages} {THPSC012}\BibitemShut {NoStop}%
	\bibitem [{\citenamefont {Gong}\ and\ \citenamefont {Chao}(2012)}]{gong12}%
	\BibitemOpen
	\bibfield  {author} {\bibinfo {author} {\bibfnamefont {C.}~\bibnamefont
			{Gong}}\ and\ \bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont {Chao}},\
	}in\ \href@noop {} {\emph {\bibinfo {booktitle} {Proc. of ICAP}}}\ (\bibinfo
	{year} {2012})\ p.\ \bibinfo {pages} {TUABI1}\BibitemShut {NoStop}%
	...
	\bibitem [{\citenamefont {Gong}\ and\ \citenamefont {Chao}(2015)}]{gong15}%
	\BibitemOpen
	\bibfield  {author} {\bibinfo {author} {\bibfnamefont {C.}~\bibnamefont
			{Gong}}\ and\ \bibinfo {author} {\bibfnamefont {Y.}~\bibnamefont {Chao}},\
	}in\ \href@noop {} {\emph {\bibinfo {booktitle} {Proc. of ICAP}}}\ (\bibinfo
	{year} {2015})\ p.\ \bibinfo {pages} {THCWC4}\BibitemShut {NoStop}%
	\bibitem [{\citenamefont {Gong}(2015)}]{gongthesis15}%
	\BibitemOpen
	\bibfield  {author} {\bibinfo {author} {\bibfnamefont {C.}~\bibnamefont
			{Gong}},\ }\emph {\bibinfo {title} {A Novel Optimization Platform and Its
			Applications to the TRIUMF Energy Recovery Linac}},\ \href@noop {} {Ph.D.
		thesis},\ \bibinfo  {school} {The University of Columbia} (\bibinfo {year}
