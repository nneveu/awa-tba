...
The following information was added on lines 401-404:

These structures are called Power Extractor and Transfer Structure (PETS), 
and will be located after the septum and quadrupoles in Fig.~7.
This device is putting the tightest constraints on the beam parameters.  
The aperture diameter is 17.6 mm and the bunch length should be below 2 mm
to facilitate large power extraction~[new ref here]   


The following information was added on lines 457-475:
...
The optimization results shown here start at the gun and go through to the first quadrupole after the septum (s3=19.4~(m)).  
These results were used as the basis for the full solution up to the PETS [new ref here].
...
were in good agreement with simulation results~[new ref here]. 
...
{\bf Our response:} {\color{blue} Line 123 in the new manuscript indicates this capability is in GPT too.}
...
{\bf Our response:} {\color{blue} 
	Additions were made to the text to enhance the discussion of the 
	physical problem and extend the discussion of the results.  For example, 
	the abstract was extended, and additional discussion was added to the 
	optimization results section. The code snippets were moved out of the 
	main body of the paper.  However, we would also like to keep some 
	computational details for those who may be interested in code 
	development specifically for accelerator optimization.  Hopefully this 
	is justified since "Computing and algorithms" is listed under PRAB's 
	scope.
}
...
{\bf Our response: }{\color{blue} 	
	We hope the additions above (including response to Ref. A) are addressing these issues.}
