...
machine configurations can be done at different charge levels. While other codes such as GPT  and ELEGANT, also have integrated genetic optimization algorithms; the OPAL framework, differentiates itself by being open source (i.e. free to use), massively parallel, and fully 3D.
}
