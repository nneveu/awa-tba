~\cite{hofler13,bazarov05,yrss:09,jefferson,gull1,gull2} \documentclass{article}
\usepackage{latexsym}
\usepackage{color}
...
{\bf Our response:} {\color{blue} 
	To address this concern, the following was added on lines 28-41 in the updated manuscript:
