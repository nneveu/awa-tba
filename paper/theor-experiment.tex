...
maintaining the physics of interest. We choose ten thousand particles 
in combination with adjusting the time step near sensitive elements (i.e. quadurpoles). 
The resulting simulations are low fidelity, but closely approximate 
the mid fidelity simulations for metrics of interest, as shown in Fig. \ref{tstep}.
\begin{figure}\ref{tstep}
	\centering
	%\includegraphics[width=0.8\linewidth]{Report/}
