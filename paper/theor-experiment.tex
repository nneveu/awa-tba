...
recombination probability, number of individuals (initial \lsnote{you have an extra `and' here} and for later generations), 
...
The optimization parameters specific to OPAL input for ex-3 \lsnote{are} given as an example.
...
These numbers \lsnote{were} in part based on the architecture of the KNL's. 
