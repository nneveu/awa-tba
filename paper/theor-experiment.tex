...
four 50 generation optimization experiments were done with varying GA parameters. 
Similar to the time step scan, the goal was to determine which set of optimization
parameters strongly influence the results, and whether there was a time to solution
difference. (NOTE FOR EDIT: May need to take this out, or compare at 50 generations, none of these runs finished 100 gens)
