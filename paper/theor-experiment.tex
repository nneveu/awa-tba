...
improved, but from Fig. \ref{expareto1}, we can see this is not the case.
...
\begin{figure}
	...
	\label{exparetos2}
	\end{subfigure}
	\caption{Comparison of Pareto fronts for initial experiments.}
	\label{expareto}
\end{figure}
