...
\lsedit{Do you mean `the objectives are optimized at location s3' in the above sentence? `location of interest for objectives' is not clear.  Also, I think your later text `This is the entrance to the fifth quad in the beam line. This location is where the beam should be captured and focused through subsequent elements.' should be moved here.}
...
\lsedit{as previously mentioned, move above two sentences.}
