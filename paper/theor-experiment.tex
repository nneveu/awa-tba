...
\begin{figure}
	...
	\node[fill=white, inner sep=2pt] (txt2) at (10,-10) {$s_1$};
...
\begin{figure}
	...
	\node[fill=white, inner sep=2pt] (txt2) at (35,31) {$s_3$};
	\node[fill=white, inner sep=2pt] (txt2) at (24,50) {Septum};
	\draw [blue, ->, line width=1] (30,50) -- (30, 42);	
	\node[fill=white, inner sep=2pt] (txt2) at (5,50) {Kicker};
	\draw [blue, ->, line width=1] (10,50) -- (18, 43);
	\end{tikzpicture}
	\caption{Continuation of the high charge beam line layout at the AWA. 
		This is the the two beam acceleration section.}
	\label{awa-tba}
\end{figure}
