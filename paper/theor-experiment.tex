...
Given the parameters and variable boundaries in Section \ref{awaproblem}, 
four optimization experiments were done with varying GA parameters, see Table \ref{extable}.
