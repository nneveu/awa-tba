...
\author{Y. Ineichen\footnotemark[2]\ \footnotemark[3]\ \footnotemark[4]
...
A validation and a proof of concept application of a beam dynamics problem is
...
The authors thank the \textsc{SwissFEL} team for contributing to the
