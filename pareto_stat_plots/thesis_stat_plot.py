...
files = glob.glob('/home/nicole/Documents/awa-tba/run_opt_params/thesis/*.stat')
for myfile in files:
    try:
        dsets = load_dataset('../run_opt_params/thesis', fname=myfile)#fname='optLinac-40nC.stat')            
        ds = dsets[0]
